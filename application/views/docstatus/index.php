<div class="card card-custom bg-danger">
    <div class="card-header flex-wrap">
        ...
        <div class="card-toolbar">
            ...
            <a href="<?= base_url() ?>docstatus/form" class="btn btn-white text-danger font-weight-bolder ml-2">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $row['name'] ?></td>
                        <td>
                            <a href="<?= base_url() ?>docstatus/form?type=<?= $row['code'] ?>" class="btn btn-danger btn-icon btn-sm"><i class="la la-pencil"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
