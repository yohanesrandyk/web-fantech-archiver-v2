<div class="card card-custom bg-danger">
    <div class="card-header flex-wrap">
        ...
        <div class="card-toolbar">
            ...
            <a href="<?= base_url() ?>doctype/form" class="btn btn-white text-danger font-weight-bolder ml-2">
    ...
    <div class="card-body">
        <table class="table table-bordered nowrap table-responsive" id="table">
            ...
            <tbody>
                <?php
                $no = 1;
                foreach ($this->mod_document_type->get_document_type() as $row) {
                ?>
                    <tr>
                        <td><?= $no++ ?></td>
                        <td><?= $row['code'] ?></td>
                        <td><?= $row['name'] ?></td>
                        <td>
                            <a href="<?= base_url() ?>doctype/form?id=<?= $row['id'] ?>" class="btn btn-danger btn-icon btn-sm"><i class="la la-pencil"></i></a>
                            <a href="<?= base_url() ?>doctype/delete/<?= $row['id'] ?>" class="btn btn-danger btn-icon btn-sm"><i class="la la-trash"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
